...
contract NftFactory is  Ownable  {
    ...
    mapping(address nft => mapping(uint256 => ListedToken)) private nftToTokenIdToListedTokenInfo;
    ...
    function createNFT(string memory name, string memory symbol,uint256 _supplyLimit,uint256 priceOfNft,bool _isTransferable,bool _isExpireable, uint256 expiration) public returns(address){
